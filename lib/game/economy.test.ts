...
test('SHOP_CATALOG has the three accepted items, 1,330 total across all tiers', () => {
...
test('purchasing quietStep twice in sequence costs 80+150 and lands at tier 2', () => {
  let s: EmbersState = { balance: 230, tiers: {} };
...
test('POCKET_STONES_COSTS/RESERVE are the accepted single-tier price and grant', () => {
  assert.deepEqual(QUIET_STEP_COSTS, [80, 150]);
